...
export default function CommentActionsMenu({
	...
	return (
		<div
			ref={dropdownRef}
			className="absolute right-0 top-full mt-1 z-50 min-w-[140px] overflow-hidden rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-[#1f1f1f]"
		>
			<div className="py-1">
				{canEdit && (
					<button
