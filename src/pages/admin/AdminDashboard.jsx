...
import AdminTallyModal from "../../components/admin/AdminTallyModal";
import ManageUsersModal from "../../components/admin/ManageUsersModal";
import MasterFilesModal from "../../components/master/MasterFilesModal";
import ReportsModal from "../../components/admin/ReportsModal";
import EvaluationManagementModal from "../../components/admin/EvaluationManagementModal";
...
export default function AdminDashboard() {
	...
	return (
		<div className="flex flex-col min-h-screen bg-gray-200 dark:bg-[#121212]">
			...
			<div className="flex sticky z-10 top-0 items-center px-4 py-2 w-full bg-gray-200 dark:bg-[#121212] md:px-8 ">
				...
				>
					...
					<div className="p-4 space-y-3">
						...
						<button
							...
							className="flex gap-3 items-center px-4 py-3 w-full text-left text-gray-700 bg-gray-50 rounded-xl transition-all duration-200 dark:text-gray-300 dark:bg-gray-700/50 hover:bg-purple-50 hover:text-purple-700 dark:hover:bg-purple-900/20 dark:hover:text-purple-300"
						>
						...
						<button
							onClick={handleMasterFilesClick}
							className="flex gap-3 items-center px-4 py-3 w-full text-left text-gray-700 bg-gray-50 rounded-xl transition-all duration-200 dark:text-gray-300 dark:bg-gray-700/50 hover:bg-orange-50 hover:text-orange-700 dark:hover:bg-orange-900/20 dark:hover:text-orange-300"
						>
							<div className="p-2 bg-orange-100 rounded-lg dark:bg-orange-900/30">
								<FolderOpen className="w-4 h-4 text-orange-600 dark:text-orange-400" />
							</div>
							<span className="font-medium">Master Files</span>
						</button>
						<button
						...
						>
							<div className="p-2 bg-blue-100 rounded-lg dark:bg-blue-900/30">
								<FileChartColumn className="w-4 h-4 text-blue-600 dark:text-blue-400" />
							</div>
			...
			<div className="flex flex-col lg:flex-row flex-1 gap-4 lg:gap-6 px-2 py-4 mx-auto w-full max-w-7xl">
				{/* Left Sidebar */}
				<aside className="hidden flex-col p-6 mt-4 w-64 bg-gray-50 rounded-2xl shadow-sm lg:flex dark:bg-[#282828] sticky top-20 h-fit max-h-[calc(90vh-6rem)] overflow-y-auto scrollbar-hide">
					<div className="mb-6">
					...
					<div className="space-y-1">
						...
						<button
							onClick={handleManageUsersClick}
							className="flex gap-3 items-center py-3 w-full text-left text-gray-700 rounded-xl transition-all duration-200 dark:text-gray-300 hover:bg-purple-50 hover:text-purple-700 dark:hover:bg-purple-900/20 dark:hover:text-purple-300 group"
						>
							...
							<div>
								...
								<div className="text-xs text-gray-500 dark:text-gray-400">
									Add and edit Admin, Faculty, Students
								</div>
							</div>
						</button>
						<button
							onClick={handleMasterFilesClick}
							className="flex gap-3 items-center py-3 w-full text-left text-gray-700 rounded-xl transition-all duration-200 dark:text-gray-300 hover:bg-orange-50 hover:text-orange-700 dark:hover:bg-orange-900/20 dark:hover:text-orange-300 group"
						>
							<div className="p-2 bg-orange-100 rounded-lg transition-colors duration-200 dark:bg-orange-900/30 group-hover:bg-orange-200 dark:group-hover:bg-orange-900/50">
								<FolderOpen className="w-4 h-4 text-orange-600 dark:text-orange-400" />
							</div>
							<div>
								<div className="font-medium">Master Files</div>
								<div className="text-xs text-gray-500 dark:text-gray-400">
									Manage important documents and resources
								</div>
							</div>
						</button>
						<button
			...
			<MasterFilesModal
				...
				onClose={() => setMasterFilesOpen(false)}
			/>
